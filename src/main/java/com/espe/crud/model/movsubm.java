...
@Entity
@Table(name = "UZMTMOVSUBM")
public class movsubm {
	
	@SequenceGenerator(name = "SEQ_UZMTMOVSUBM", sequenceName = "SEQ_UZMTMOVSUBM", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_UZMTMOVSUBM")
	@Id
	...
	public movsubm(Long tipmov_id, String nombre, String usuario_crea, Date fecha_crea, String usuario_mod,
			Date fecha_mod) {
		super();
